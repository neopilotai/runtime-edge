...
```sh
npm install @runtime-edge/jest-expect --save
```

or using yarn:

```sh
yarn add @runtime-edge/jest-expect --dev
```

or using pnpm:

```sh
pnpm install @runtime-edge/jest-expect --save
```

## License

**@runtime-edge/expect** © [Vercel](https://vercel.com), released under the [MPLv2](https://github.com/khulnasoft/runtime-edge/blob/main/LICENSE.md) License.<br>
